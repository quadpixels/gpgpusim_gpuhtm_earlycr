...
public:
   ...
   int get_ref_count(); 
	...
	virtual bool tm_access( memory_space* mem, memory_space_t space, bool rd, addr_t addr, void* vp, int nbytes, tm_access_uarch_info& uarch_info ) = 0; // return false if validation failed 
